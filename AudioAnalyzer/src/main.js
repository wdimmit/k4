...
/*	           Container($, {anchor: "LEFTBUTTON", left: 10, top: 0, height: 40, width: 120, 
	   			   active: true, skin: menuButtonSkin,
	        	   behavior: Object.create(Behavior.prototype, {
		       		   onCreate: { value: function(container, data) {
       			   		   this.data = data;
		    		   }},
	        		   onTouchEnded: { value: function(container, id, x,  y, ticks) {
	        			   ...
	        			   if (this.data.actionButton == 'Start') {
	        				   this.data.actionButton = 'Pause';
	        				   this.data.labels.actionLabel.string = 'Pause';
	        				   application.invoke(new MessageWithObject("pins:/microphone/read?repeat=on&timer=audio&callback=/gotAudio"));
	        			   }
	        			   else {
	        				   this.data.actionButton = 'Start';
	        				   this.data.labels.actionLabel.string = 'Start';
	        	   ...
	        	   contents: [
	        	              data.labels.actionLabel,        	              
		              ]
	        	   }),    	   
		           Container($, {anchor: "FASTBUTTON", right: 00, top: 0, height: 40, width: 40, 
		        	   active: true, skin: menuButtonSkin,
		        	   behavior: Object.create(Behavior.prototype, {
			       		   onCreate: { value: function(container, data) {
	       			   		   this.data = data;
		        	   ...
		        	   contents: [
	        	              data.labels.fastLabel      	              
		               ],
		           }),
		           Container($, {anchor: "PRECISEBUTTON", right: 50, top: 0, height: 40, width: 40, 
		        	   active: true, skin: menuButtonSkin,
		        	   behavior: Object.create(Behavior.prototype, {
			       		   onCreate: { value: function(container, data) {
	       			   		   this.data = data;
	        	   ...
	        	   contents: [
        	              data.labels.preciseLabel      	              
	              ]
	           }),
	           Container($, {anchor: "TUNERBUTTON", right: 110, top: 0, height: 40, width: 40, 
	        	   active: true, skin: menuButtonSkin,
	        	   behavior: Object.create(Behavior.prototype, {
		       		   onCreate: { value: function(container, data) {
       			   		   this.data = data;
